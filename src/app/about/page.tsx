...
const About: React.FC = () => {
  return (
    <section className="container mx-auto py-10 md:py-14 w-full max-w-4xl px-4">
      <div className="flex flex-col items-center text-center mb-10">
        <Badge variant="soft" className="mb-3">
          Sobre
        </Badge>
        <h1 className="text-balance text-3xl md:text-4xl font-bold tracking-tight">
          Sobre a plataforma <span className="gradient-text">Unclassed</span>
        </h1>
        <p className="mt-3 max-w-2xl text-muted-foreground">
          Uma plataforma desenvolvida pelo Núcleo de Estudantes de Informática
          do ISEP, feita por estudantes para estudantes.
        </p>
      </div>
        ...
        <CardContent className="relative p-6 md:p-10 flex flex-col items-center text-center gap-4">
          ...
          <div>
            <h3 className="text-xl md:text-2xl font-bold">
              Encontraste algum <span className="text-primary">erro</span> ou
              precisas de ajuda?
            </h3>
            <p className="mt-2 text-sm text-muted-foreground max-w-xl">
              Estamos à distância de um email. Conta-nos como podes ajudar a
