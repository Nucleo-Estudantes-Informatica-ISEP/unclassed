    ...
    body: (
      <>
        ...
        <ul className="mt-3 space-y-2 list-disc list-inside">
          <li>
            <span className="font-semibold">Essenciais:</span> necessários para
            o funcionamento adequado do website (ex: autenticação).
          </li>
          <li>
            <span className="font-semibold">Desempenho e análise:</span>{" "}
            recolhem informação sobre como os visitantes usam o website e ajudam
            a melhorar o desempenho.
          </li>
          <li>
            <span className="font-semibold">Personalização:</span> lembram as
            tuas preferências e fornecem conteúdo personalizado.
          </li>
        </ul>
        <p className="mt-3">
          A plataforma Unclassed utiliza apenas cookies essenciais para garantir o seu
    ...
    <section className="container mx-auto py-10 md:py-14 w-full max-w-3xl px-4">
      ...
      <Card className="shadow-md">
        <CardContent className="p-6 md:p-8 space-y-6 text-sm md:text-base leading-relaxed">
          <p>
            Esta política explica como a plataforma Unclassed utiliza cookies e
            tecnologias similares para recolher e armazenar informação quando a
            visitas. Ao continuares a usá-la, concordas com o uso de cookies de
