  ...
  private async getRequestDetails(
    ...
    if (singleRequest) {
      ...
      return {
        ...
        preferenceOrderMatters: sr.preferenceOrderMatters ?? true,
        requestType: "single",
    ...
    if (bundleRequest) {
      ...
      return {
        ...
        preferenceOrderMatters: br.preferenceOrderMatters ?? true,
        requestType: "bundle",
  ...
  private async findCompatibleRequests(
    ...
    if (request.requestType === "single") {
      ...
      return filtered.map((r: SingleSwapRequestRecord) => ({
        ...
        preferenceOrderMatters: r.preferenceOrderMatters ?? true,
        requestType: "single",
        priority: r.priority,
